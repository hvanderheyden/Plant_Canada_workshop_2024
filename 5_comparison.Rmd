...
saveRDS(WorkingPS_glom2, file= "Processed_data/WorkingPS_glom2.rds")
...
```{r}
Ion_nano<- subset_samples(WorkingPS_glom2, seq_tech !="Illumina")
...
Ion_Illu<- subset_samples(WorkingPS_glom2, seq_tech !="Nanopore")
...
```{r}
##### Adonis for diseased plantations vs forest  ####
Nano_Illu<- subset_samples(WorkingPS_glom2, seq_tech !="IonTorrent")
